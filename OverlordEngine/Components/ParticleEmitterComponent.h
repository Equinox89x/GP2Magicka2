...
{
	float minSize{ 1.8f }; //The minimum size each particle can be at the time when it is spawned
	float maxSize{ 2.f }; //The maximum size each particle can be at the time when it is spawned

	float minEnergy{ 1.8f }; //The minimum lifetime of each particle, measured in seconds
	...
	XMFLOAT3 originalVelocity{}; //The initial speed & (relative) direction of particles along X, Y and Z
	XMFLOAT3 velocity{}; //The initial speed & (relative) direction of particles along X, Y and Z
	XMFLOAT3 modifier{}; //The initial speed & (relative) direction of particles along X, Y and Z
